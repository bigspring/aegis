<?php
/**
 * Allows controllers to be treated as a simple CRUD entity, providing methods and datamapper integration 
 * Requires: 
 * Datamapper -   
 * Messages -
 * Navigation -  
...
trait Entity_Controller {
    ...
    /*
     * The name of the entities model
     */
    //public $model_name = '';
