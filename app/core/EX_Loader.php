...
class EX_Loader extends MX_Loader
{
    /**
    ...
    /**
     * Workaround for old Matchbox integration.  HMVC supports standard CI method of $this->load->library
     */
    function module_library($module, $library)
    {
     ...
     * Workaround for old Matchbox integration.  HMVC supports standard CI method of $this->load->library
     */
    function module_helper($module, $helper)
    {
    	$this->helper($module.'/'.$helper);
    }
    
    /**
     * Another workaround for old Matchbox integration
     * @param unknown_type $module
     * @param unknown_type $model
     * @param unknown_type $rewrite
     */
    function module_model($module, $model, $rewrite)
    {
    	$this->model($module.'/'.$model, $rewrite);
    }
